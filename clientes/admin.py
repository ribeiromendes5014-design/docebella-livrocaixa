...
from django.apps import apps # ⭐️ NOVO: Importa o registry de apps do Django
...
class VendaInline(admin.TabularInline):
    # ⭐️ CORREÇÃO: Obtém o modelo 'Venda' dinamicamente para evitar importação circular
    model = apps.get_model('vendas', 'Venda')
    extra = 0
    can_delete = False

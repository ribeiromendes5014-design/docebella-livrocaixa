...
# Importa os modelos
from .models import Categoria, FormaPagamento, Movimentacao, ConfiguracaoCashback
...
class ConfiguracaoCashbackAdmin(admin.ModelAdmin):
    def has_add_permission(self, request):
        ...
        return not ConfiguracaoCashback.objects.exists()

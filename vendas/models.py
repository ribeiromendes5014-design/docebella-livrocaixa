...
class Venda(models.Model):
    ...
    movimentacao_caixa = models.ForeignKey(Movimentacao, on_delete=models.SET_NULL, null=True, blank=True, related_name='venda_entrada')
...
class ItemVenda(models.Model):
    """
    Itens de cada venda (o que foi vendido).
    """
    venda = models.ForeignKey(Venda, on_delete=models.CASCADE)
    produto = models.ForeignKey(Produto, on_delete=models.PROTECT)
    quantidade = models.IntegerField()
    valor_unitario_praticado = models.DecimalField(max_digits=10, decimal_places=2)

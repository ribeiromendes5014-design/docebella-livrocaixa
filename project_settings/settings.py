...
ALLOWED_HOSTS = os.environ.get(
    'ALLOWED_HOSTS', 
    '127.0.0.1,localhost,docebella-livrocaixa-p1mf.onrender.com' 
).split(',')
...
DATABASES = {
    'default': dj_database_url.config(
        default='postgresql://livrocaixa_vru8_user:gOokftfeZr4CpMqqXGruxjuJNzQxXyZk@dpg-d49b62k9c44c73bj1rgg-a.oregon-postgres.render.com/livrocaixa_vru8',
        conn_max_age=600,
        ssl_require=True
    )
}
...
# Isso adiciona um hash aos nomes dos arquivos, permitindo um cache seguro e de longo prazo no navegador.
